...
import {FormParamDefinition, QueryParamDefinition, VariableDefinition} from "postman-collection";
...
export const EditableTable:FC<EditableTableProps<VariableDefinition|QueryParamDefinition|FormParamDefinition>> = ({value,
                                                                             onValueChange,onKeyChange,onDisabled,disabled,
        ...
        return <>
            <table className="table-fixed w-full">
                ...
                {collection&&value.map((v,i)=>{
                    return <tr key={i}>
                        {!disabled&&<td><input type="checkbox" checked={v.disabled !== undefined ?!v.disabled: true} onChange={v=>{
